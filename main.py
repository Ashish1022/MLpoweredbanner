...
def text_field_container(expand: bool | int, name: str, control: ft.TextField):
    return ft.Container(
        ...
        content=ft.Column(
            spacing=1,
            controls=[
                ft.Text(value=name, size=15, color="black", weight="bold"),
                control,
            ],
        ),
    )
...
class Form(ft.Container):
    def __init__(self, dt: ft.DataTable):
        ...
        self.row1 = text_field_container(True, "FullName : ", self.row1_value)
        self.row2 = text_field_container(3, "Placed at : ", self.row2_value)
        self.row3 = text_field_container(1, "Score : ", self.row3_value)
        self.row4 = text_field_container(1, "MIS No. : ", self.row4_value)

        # define a button to add the data
        ...
        # define a button to add image 
        self.image = ft.ElevatedButton(
            text="Add Images",
            style=ft.ButtonStyle(shape={"": ft.RoundedRectangleBorder(radius=8)}),
            # on_click=self.image_data,
        )
        ...
        self.content = ft.Column(
            ...
            controls=[
                ...
                ft.Row(controls=[self.add,self.image,self.submit], alignment="end"),
            ],
        )

    # defie a method to submit data
    def add_data(self, e: ft.TapEvent):
...
column_names = ["Name", "MIS No.", "Score", "Placed at"]
